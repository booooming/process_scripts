# -*- coding: utf-8 -*-
"""
@Time ： 2021/7/24 13:10
@Auth ： wongbooming
@File ：seg_gt&pre_evaluate_criteria.py
@Explain : 分割的真值与预测mask之间的评价指标
"""
...
if __name__ == '__main__':
    ...
    img_GT = cv2.imread(
        r"E:\Yizhun-AI\data\ACL_test\1.3.12.2.1107.5.2.32.35183.2013111212344478401266893.0.0.0\mask\6.png", 0)
    img_R = cv2.imread(
        r"E:\Yizhun-AI\data\ACL_test\1.3.12.2.1107.5.2.32.35183.2013111212344478401266893.0.0.0\mask\6.png", 0)
